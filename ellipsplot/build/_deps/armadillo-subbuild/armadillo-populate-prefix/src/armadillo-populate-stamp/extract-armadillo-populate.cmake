...
#
get_filename_component(filename "/workspaces/Labor/ellipsplot/build/_deps/armadillo-subbuild/armadillo-populate-prefix/src/armadillo-12.4.0.tar.xz" ABSOLUTE)
get_filename_component(directory "/workspaces/Labor/ellipsplot/build/_deps/armadillo-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-armadillo-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-armadillo-populate${i}")
